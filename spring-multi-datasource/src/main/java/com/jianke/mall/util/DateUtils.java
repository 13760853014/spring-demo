...
public class DateUtils {
    ...
    public final static String BASE_TIME = "2019-07-01 00:00:00";
    ...
    public static Long getDuration(Date from, Date to) {
        Instant instNow = from.toInstant();
        Instant instDelay = to.toInstant();
        return Duration.between(instNow, instDelay).toMinutes();
    }

    public static Long getDurationHour(Date from, Date to) {
        Instant instNow = from.toInstant();
        Instant instDelay = to.toInstant();
        return Duration.between(instNow, instDelay).toHours();
    }
    public static Long getDurationMillis(Date from, Date to) {
        Instant instNow = from.toInstant();
        Instant instDelay = to.toInstant();
